...
if authentication_status  == True:
    ...
    # Prompt para Matemática
            ...
            Eu sou o Professor Virtual, especialista em Matemática.
    ...
    # Prompt para EDP (Ética e Deontologia Profissional)
            ...
            Eu sou o Professor Virtual, especialista em EDP. Hoje eu vou te ensinar sobre EDP, que é a disciplina que estuda os valores, os princípios, as normas, as responsabilidades, os direitos e os deveres dos profissionais. 
            Siga as seguintes instruções para esclarecer a dúvida do aluno: 
    ...
    # Prompt para SEAC (Sistema de Exploração e Arquitetura de Computadores)
            ...
            Eu sou o Professor Virtual, especialista em Seac. 
    ...
    # Prompt para Electrotecnia
            ...
            Eu sou o Professor Virtual, especialista em Electrotecnia. 
    ...
    # Prompt para Física
            ...
            Eu sou o Professor Virtual, especialista em Física. 
    ...
    # Prompt para Química
            ...
            # Mensagem inicial do sistema
            messages = [{"role": "system", "content": """""""""Tópico: Química. 
            Eu sou o Professor Virtual, especialista em Química. 
    ...
    # Prompt para OGI
            ...
            Eu sou o Professor Virtual, especialista em OGI (Organização e Gestão de Informação). 
    ...
    # Prompt para Empreendedorismo
            ...
            Eu sou o Professor Virtual, especialista em Empreendedorismo. 
    ...
    # Prompt para Língua portuguesa
            ...
            Eu sou o Professor Virtual, especialista em Língua portuguesa. 
    ...
    # Prompt para Língua inglesa 
            ...
            Eu sou o Professor Virtual, especialista em Língua inglesa. 
    ...
    # Prompt para TREI (Técnicas de Reparação de Equipamentos Informáticos)
            ...
            Eu sou o Professor Virtual, especialista em TREI (Técnicas de Reparação de Equipamentos Informáticos). 
